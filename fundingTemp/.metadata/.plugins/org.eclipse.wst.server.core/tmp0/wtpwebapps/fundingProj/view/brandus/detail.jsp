...
<div class="productDetail">
	<table class="tableBasic" border="">
		...
		<tr>
			<th>제품소개</th>
			<td><img src="../listimg/${dto.wname }" alt="" /></td>
			
		</tr>
		<tr>
			<th>소개</th>
			<td><img src="../listimg/${dto.content }" alt="" />
		</tr>
		<tr>
			<th>목표금액</th>
	...
	<c:choose>
		<c:when test="${cat != null }">
			<div class="buttonArea">
				<a href="Inquiry?title=${dto.title }">문의</a> 
				<button id="perBtn">구매</button> 			
				<a href="MainList?cat=${cat }">뒤로가기</a>
			</div>
		</c:when>
